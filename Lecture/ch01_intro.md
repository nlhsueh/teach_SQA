...
愛國者反導彈系統（1991）在達蘭基地攔截失效，根本原因是由於雷達硬體晶片損壞，而非軟體計算的浮點數捨入誤差累積所致。
...
* **解析**：
  * 攔截失效是純粹的**軟體錯誤**。愛國者系統採用 24-bit 浮點數記錄時間，每小時有微小的截斷誤差。連續運行 100 小時後累積了 0.33 秒延遲，對於速度達 4.2 馬赫的飛彈造成約 600 公尺的偏差，導致雷達搜尋窗無法鎖定飛彈。硬體本身並無損壞。
