...
請利用 [BubbleSort](../../src/main/java/xdemo/BubbleSort.java) 的程式操作 breakpoint, 熟悉相關的工具操作
...
* [參考程式](../../src/main/java/xdemo/LowestCommonAncestor.java) （此程式有錯）

### 🚌 Lab04: Sin
* 透過泰勒展展開式計算 Sin(30)
* [參考程式](../../src/main/java/xdemo/Sin.java) （此程式有錯）
